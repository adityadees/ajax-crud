<div>
    <div class="row">
        <h1 class="page-header">Data
            ...
            <div class="pull-right"><a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#ModalaAdd"><span class="fa fa-plus"></span> Tambah Barang Keluar</a></div>
        </h1>
    </div>
    <div class="row">
        <div id="reload">
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-info" id="btn_simpan_keluar">Simpan</button>
                </div>
            </form>
        </div>
    </div>
